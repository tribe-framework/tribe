...
foreach (array_keys($types) as $type) {
        ...
        $models .= 'define("junction/models/'.$type_hyphen.'", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let '.$type_ucwords.'Model = _exports.default = (_class = class '.$type_ucwords.'Model extends _model.default {
    constructor(...args) {
      super(...args);
